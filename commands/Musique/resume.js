...
module.exports = {
    ...
    //aliases: [''],
    category: 'Musique',
    description: 'Relance la musique actuelle',
    musique: true,
    ...
    run : async (client, message, args) => {
        ...
        try {
            ...
            .setColor('#2f3136')
            .setDescription(`${emojis.bc_cross} La musique n'est pas en pause.`)
            .setFooter(`${client.user.username} © 2021`, client.user.displayAvatarURL({dynamic: true}))
            .setTimestamp()
            )
            ...
            .setColor('#2f3136')
            .setDescription(`${emojis.bc_check} La musique a bien été relancé.`)
            .setFooter(`${client.user.username} © 2021`, client.user.displayAvatarURL({dynamic: true}))
            .setTimestamp()
            )
        } catch(err) {
            ...
            .setDescription(`Une erreur dans la commande \`resume\` est survenue dans **${message.guild.name}**.`)
