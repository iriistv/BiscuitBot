...
module.exports = {
    ...
    run : async (client, message, args) => {
        ...
        try {
            ...
            .setColor('#2f3136')
            .setDescription(`${emojis.bc_check} La musique suivante est désormais en cours de lecture.`)
            .setFooter(`${client.user.username} © 2021`, client.user.displayAvatarURL({dynamic: true}))
            .setTimestamp()
            )
        } catch(err) {
            ...
            .setDescription(`Une erreur dans la commande \`skip\` est survenue dans **${message.guild.name}**.`)
